...
Point SnubDodecMesh::vertices[60] = {
...
int SnubDodecMesh::NormalCount(void)
{
    return static_cast<int>(normal.size());
}

std::vector<float> SnubDodecMesh::GetNormal()
{
    return normal;
}

std::vector<float> SnubDodecMesh::GetBuffers()
{
    return buffers;
}
